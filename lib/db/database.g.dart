...
class _$StudentDao extends StudentDao {
  ...
  @override
  Future<void> insertTasks(List<Student> students) async {
    await _studentInsertionAdapter.insertList(
        students, sqflite.ConflictAlgorithm.abort);
  }

  @override
  Future<void> updateTask(Student student) async {
    await _studentUpdateAdapter.update(
        student, sqflite.ConflictAlgorithm.abort);
  }

  @override
  Future<void> updateTasks(List<Student> student) async {
    await _studentUpdateAdapter.updateList(
        student, sqflite.ConflictAlgorithm.abort);
  }

  @override
  Future<void> deleteTask(Student student) async {
    await _studentDeletionAdapter.delete(student);
  }

  @override
  Future<void> deleteTasks(List<Student> students) async {
